...
public class SupplementaryQuizTests extends BaseTestsDesktop {

    @DataProvider(name= "BoundayTestForQuizRegardingISTQB")
     ...
     */
    @Test(dataProvider="BoundayTestForQuizRegardingISTQB")
    public void BoundayTestForQuizRegardingISTQB(String expectedResult, int val1, int val2, int val3, int val4, int val5, int val6, int val7, int val8, int val9, int val10, int val11, int val12, int val13, int val14, int val15, int val16, int val17, int val18, int val19, int val20){
